...
// Private constants
var _apiHost = process.env.SOFTLAYER_API_HOST || 'https://api.softlayer.com';
var _baseUrl = _apiHost + '/rest/v3/';
...
var _handleResponse = function(callback) {
    return function(err, res, body) {
        if (res && (res.statusCode >= 400 && res.statusCode < 600 || res.statusCode < 10)) {
